...
# 2) Initialize session_state BEFORE widget creation
...
with mid_col:
    ...
    with bcol1:
        # Reset uses callback – DO NOT call reset_message() manually anywhere else
...
# ----------------- DISCLAIMER (moved to sidebar) -----------------
st.sidebar.markdown("---")
st.sidebar.caption(
    "⚠️ This is a demo machine learning model and may make mistakes.\n\n "
    "Do not rely on it for real security decisions.\n\n"
    "🔒 Messages are not stored in the server.\n\n "
    "Only if you click the feedback buttons, the message and label are saved locally."
)
